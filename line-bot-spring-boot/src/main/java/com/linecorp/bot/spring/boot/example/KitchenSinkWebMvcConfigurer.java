...
package com.linecorp.bot.spring.boot.example;

import com.linecorp.bot.spring.boot.LineApplication;
...
public class KitchenSinkWebMvcConfigurer implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        String downloadedContentUri = LineApplication.downloadedContentDir
                .toUri().toASCIIString();
